...
class _SignUpAlumnoState extends State<SignUpAlumno>{
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController surnamesController = TextEditingController(text:"");
                  ...
                  children:  [
                    ...
                    ElevatedButton(
                      onPressed: () async{
                        ...
                        if (name.isEmpty || surnames.isEmpty || email.isEmpty || password.isEmpty || confirmPassword.isEmpty) {
